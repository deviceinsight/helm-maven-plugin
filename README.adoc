...
|deployAtEnd |`false` | Specify the helm chart should be deployed at the end of the multi-module build.
...
To use the `deployAtEnd` functionality it's mandatory to declare it only in the parent pom.
