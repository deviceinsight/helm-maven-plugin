...
| helmGroupId                    | `com.deviceinsight.helm`        | The helm binary `groupId`. You most likely will not need to change this                                                                                           |
| helmArtifactId                 | `helm`                          | The helm binary `artifactId`. You most likely will not need to change this                                                                                        |
| helmVersion                    | `3.11.2`                        | The helm binary `version`                                                                                                                                         |
...
| repos.repo[].type              | `CHART_MUSEUM`                  | The expected repository layout of the chart repo. Can be `CHART_MUSEUM` or `ARTIFACTORY`. This is only relevant when you intend to push charts to this repository |
